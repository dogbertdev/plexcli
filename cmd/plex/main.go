...
func applyOutputFormat(cli *CLI, format string) {
	...
	cli.Library.Section.Show.Output = format
	cli.Library.Section.Create.Output = format
	cli.Library.Section.Edit.Output = format
	cli.Library.Section.Delete.Output = format
	cli.Library.Section.Prefs.List.Output = format
	cli.Library.Section.Prefs.Set.Output = format
	cli.Library.Section.Prefs.Defaults.Output = format
	cli.Library.Section.Filters.Output = format
	cli.Library.Section.Sorts.Output = format
	cli.Library.Section.Letters.Output = format
	cli.Library.Refresh.Cancel.Output = format
	cli.Library.Refresh.StopAll.Output = format
	cli.Library.Item.Delete.Output = format
	cli.Library.Item.Edit.Output = format
	cli.Library.Item.Refresh.Output = format
	cli.Library.Item.Analyze.Output = format
	cli.Library.Item.Unmatch.Output = format
	cli.Library.Item.Split.Output = format
	cli.Library.Item.Merge.Output = format
	cli.Library.Item.Prefs.List.Output = format
	cli.Library.Item.Prefs.Set.Output = format
	cli.Library.Item.BulkUpdate.Output = format
	cli.Library.Subtitle.Add.Output = format
	cli.Library.Artwork.Set.Output = format
	cli.Library.Artwork.Update.Output = format
	cli.Library.Detect.Ads.Output = format
	cli.Library.Detect.Credits.Output = format
	cli.Library.Detect.Intros.Output = format
	cli.Library.Detect.DeleteIntros.Output = format
	cli.Library.Detect.Voice.Output = format
	cli.Library.Detect.BIF.Output = format
	cli.Library.Detect.Status.Output = format
	cli.Library.Discover.Tags.Output = format
	cli.Library.Discover.Collections.Output = format
	cli.Library.Discover.Common.Output = format
	cli.Library.Discover.Related.Output = format
	cli.Library.Discover.Similar.Output = format
	cli.Library.Discover.SonicSimilar.Output = format
	cli.Library.Discover.Autocomplete.Output = format
	cli.Library.Discover.Matches.Output = format
	cli.Library.Discover.RandomArt.Output = format
	cli.Library.Person.Show.Output = format
	cli.Library.Person.Media.Output = format
	cli.Library.Media.Extras.Output = format
	cli.Library.Media.Tree.Output = format
	cli.Library.Media.Leaves.Output = format
	cli.Library.Media.Stream.Delete.Output = format
	cli.Library.Media.Stream.Offset.Output = format
	cli.Library.Media.Levels.Output = format
	cli.Library.Media.Loudness.Output = format
	cli.Library.Media.Marker.Create.Output = format
	cli.Library.Media.Marker.Edit.Output = format
	cli.Library.Media.Marker.Delete.Output = format
